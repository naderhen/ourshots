class FriendsController < UICollectionViewController
  ...
  #   @window.rootViewController = FriendsController.new
  #
  # Or if you're adding using it in a navigation controller, do this
  #  main_controller = FriendsController.new
  #  @window.rootViewController = UINavigationController.alloc.initWithRootViewController(main_controller)

  FRIENDS_CELL_ID = "FriendsCell"
  ...
  def viewDidLoad
    ...
    rmq.stylesheet = FriendsControllerStylesheet

    collectionView.tap do |cv|
      cv.registerClass(FriendsCell, forCellWithReuseIdentifier: FRIENDS_CELL_ID)
      cv.delegate = self
      cv.dataSource = self
  ...
  def collectionView(view, cellForItemAtIndexPath: index_path)
    view.dequeueReusableCellWithReuseIdentifier(FRIENDS_CELL_ID, forIndexPath: index_path).tap do |cell|
